# call_center_audio_dual_channel_as
**Dataset Description:**

This dataset is a **large-scale collection of raw Assamese call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
